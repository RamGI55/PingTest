...
APingTestCharacter::APingTestCharacter()
{
...
void APingTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APingTestCharacter::Move);
...
void APingTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APingTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
